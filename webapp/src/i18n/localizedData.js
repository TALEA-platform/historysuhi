...
const englishLayerOverrides = {
  view1Layers: {
    lst: {
      ...
      subtitle: "Hottest and coolest surfaces in the selected year",
      description:
        "Shows the surface heat observed in the selected year. It a direct reading: it indicates how hot roads, roofs, paved areas and vegetation appear in summer satellite observations.",
      explanation:
        "Use it to understand where the surface heats up the most in absolute terms. A road or a roof can be much hotter than the air people breathe (satellite-observed surface data).",
      details: [
        "Blue and green indicate relatively cool surfaces; orange and red indicate very hot surfaces.",
        "This map lets you compare different years with the Compare slider.",
        "It differs from the second layer because here you read the heat value itself, not the relationship with the city's annual average.",
      ...
      legendTitle: "Hot/cool surfaces",
      legend: ["coolest", "cool", "intermediate", "hot", "very hot", "among the hottest"],
      noDataLabel: "No data",
      noDataDescription:
    ...
    zspat: {
      title: "Hotter and cooler areas in the selected year",
      subtitle: "How much a place differs from the urban average in the same year",
      description:
        "This map shows whether a location is hotter or cooler than Bologna's average **in the same year**. It does not show how hot a surface is in absolute terms.",
      explanation:
      ...
      details: [
        ...
        "An area can appear red even in a non-extreme year if it is hotter than the rest of the city in that year.",
        "Use it to understand differences between districts and urban zones within the same selected year.",
        "Hatched areas mean data not available: at that location the satellite did not collect valid summer observations in the selected year.",
      ],
      valueInfo:
        "When you enable values, the number is not a temperature. It is a **standardized deviation**: 0 means close to the city's annual average, positive values indicate zones hotter than average, negative values zones cooler than average.",
      legendTitle: "Compared with the city",
      legend: ["much cooler", "cooler", "in line", "hotter", "much hotter"],
      noDataLabel: "No data",
      noDataDescription:
        "At this location the satellite did not collect valid summer observations in the selected year, so the map leaves it as no data.",
  ...
  view2Layers: {
    anomaly: {
      title: "Hotter or cooler than normal in 2025",
      ...
      explanation:
        "Blue indicates places cooler than their usual pattern, white places in line, red places hotter than their usual pattern. Each point is compared with its own history, not with the rest of the city.",
      details: [
        "A location that is usually hot can appear white if in 2025 it behaved as usual.",
        "A place that is not especially hot in absolute terms can appear red if in 2025 it was hotter than its own history.",
      ],
    ...
    climatology: {
      ...
      description:
        "Shows the **historical mean** of surface temperature across summers 2013-2025. It is the baseline map for View 2: it helps you see which areas are normally hot or cool.",
      explanation:
        "Read it as the usual behaviour of the surface. An industrial area, a large parking lot or parts of the historic centre can appear hot here even when they are not anomalous: that means they are recurrently hot.",
      details: [
      ...
      moreInfo: [
        "If an area is hot on this map it means that area tends to be hot across the 2013-2025 series.",
      ...
      legend: ["historically cool", "cool", "intermediate", "hot", "very hot", "historically among the hottest"],
    },
    persistenceTemporal: {
      ...
      details: [
        ...
        "Rare anomalies do not automatically mean a cool area: they can also indicate stable, consistently high heat.",
      ...
      inspectNote: "Few anomalies do not necessarily mean cool conditions: also check the chronically hot areas layer.",
    ...
    persistenceStructural: {
      ...
      subtitle: "Places that rank among the city's hottest areas in many years",
      description:
        "Shows how many times each point ranked within the **top 5% hottest areas** in Bologna. Here 'chronic' means a repeated critical condition in urban space, year after year.",
      explanation:
        "Use it to identify places that are often among the city's hottest areas, even when they are not anomalous compared with their own history.",
      details: [
    ...
    chronicVsAnomalous2025: {
      ...
      details: [
        "Chronic means that the point falls within the **top 5% hottest areas** of the selected year (2025).",
    ...
    structuralVsTemporal: {
      ...
      description:
        "Crosses, for the full 2013-2025 period, how many times an area ranked in the **top 5% hottest areas** and how many times it was **anomalous compared with its own history**.",
      explanation:
        "",
      details: [
      ...
      moreInfo: [
        "Low anomaly does not necessarily mean a cool area. It can also indicate a place that is always hot and stable, such as some parts of the historic centre.",
  ...
  view3Layers: {
    uhei: {
      ...
      subtitle: "Where heat, little vegetation and dark surfaces show up together",
      description:
        "Shows where three conditions overlap in the same place: hotter surfaces, limited vegetation and surfaces that reflect little sunlight. When all three meet, overall heat exposure is higher — not because any single cause is enough on its own, but because they reinforce each other.",
      explanation:
      ...
      details: [
        "Higher values indicate greater overall exposure to surface heat.",
      ...
      valueInfo:
        "This value is a **synthetic index, not a temperature in °C**. The number combines surface heat, limited vegetation and poorly reflective surfaces: higher values indicate physical conditions that are more exposed to heat.",
    ...
    hvi: {
      title: "Heat and lack of vegetation",
      subtitle: "Helps show where additional greenery could make a bigger difference",
      description:
        "A deeper-reading layer: it combines surface heat and lack of greenery. It is useful when you want to see where vegetation could have the greatest impact.",
      explanation:
        "Red means hot with little vegetation; blue means cooler and greener. It does not replace the overall heat exposure index: it explains one of its components.",
      details: [
        "Use it to read the relationship between heat and vegetation.",
        "It is more useful for reasoning about mitigation priorities than for describing a temperature.",
      ],
      valueInfo:
        "This is a **comparative index**, not a measure in °C. Positive values indicate situations where surface heat and limited vegetation weigh more; negative values indicate relatively cooler or greener conditions.",
      legendTitle: "Heat and vegetation",
      legend: ["cool and green", "intermediate", "hot and low vegetation"],
    },
    hri: {
      title: "Heat and poorly reflective surfaces",
      subtitle: "Helps read the weight of roofs, pavements and materials that absorb heat",
      description:
        "A deeper-reading layer: it combines surface heat and poorly reflective surfaces. It helps show where materials, roofs and pavements may contribute to heat.",
      explanation:
        "Red means hot with dark or absorbent surfaces; blue means cooler and more reflective. It does not replace the overall heat exposure index: it explains one of its components.",
      details: [
        "Use it to read the relationship between heat and absorbent materials.",
        "It supports reasoning about pavements, roofs, paved areas and mineral surfaces.",
      ],
      valueInfo:
        "This is a **comparative index**, not a temperature. Positive values indicate heat associated with poorly reflective surfaces; negative values indicate cooler conditions or more reflective surfaces.",
      legendTitle: "Heat and surfaces",
      legend: ["cool and bright", "intermediate", "hot and dark"],
    },
  },
  deltaLayer: {
    title: "Difference between day and night",
    subtitle: "Where the surface cools a lot and where it tends to stay warm",
    description:
  ...
  districtMetrics: {
    uhei: {
      ...
      valueInfo:
        "It is the **mean synthetic index of the selected area**, not a temperature and not a direct measure of health risk. It summarizes three physical conditions: **surface heat**, **vegetation presence** and **the ability of surfaces to reflect light**. The number has no unit: it is mainly used to compare selected areas with one another. Higher values indicate a less favorable combination; lower values do not mean there is no heat, only that average conditions are less critical.",
    },
    lst: {
      label: "Surface heat",
    ...
    anomaly: {
      ...
      valueInfo:
        "It is the **mean 2025 departure** from the usual behaviour of the same selected area. It is measured in °C because it compares two surface temperatures. A positive value means the area was hotter than its usual pattern in 2025; a negative value means it was cooler than usual. It does not say whether the area is hot in absolute terms: it says how much 2025 diverged from its own history.",
    },
    hotspotPercent: {
