...
export function View4({ csvInfo }) {
  ...
  const copy = language === "en"
    ? {
      ...
      bannerText:
        "This view shows the **day-night temperature range** (how much surfaces heat up during the day and cool down at night) observed in summer **2026**. A high value indicates a strong day-night swing; a low value can indicate surfaces that change little, or areas with **already lower daytime temperatures** that therefore have less heat to lose overnight.",
