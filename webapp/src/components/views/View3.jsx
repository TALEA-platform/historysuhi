...
export function View3() {
  ...
  const copy = language === "en"
    ? {
      ...
      uheiBody: "Heat, little vegetation and dark surfaces, read together",
      hviBody: "Where heat outweighs vegetation",
      hriBody: "Where dark materials and heat reinforce each other",
    ...
    : {
      ...
      uheiBody: "Caldo, poco verde e superfici scure, letti insieme",
      hviBody: "Dove il caldo prevale sulla vegetazione",
      hriBody: "Dove materiali scuri e calore si sommano",
