...
export function DistrictDetail({ district, rank, metricKey, aggregation }) {
  ...
  const copy = language === "en"
    ? {
      ...
      anomalyHotter: "In 2026 this area's temperature was **above its usual** behaviour.",
      anomalyCooler: "In 2026 this area's temperature was **below its usual** behaviour.",
      anomalyFlat: "In 2026 this area was close to its usual behaviour.",
    ...
    : {
      ...
      anomalyHotter: "Nel 2026 questa zona ha avuto una **temperatura sopra il suo solito**.",
      anomalyCooler: "Nel 2026 questa zona ha avuto una **temperatura sotto il suo solito**.",
      anomalyFlat: "Nel 2026 questa zona è stata in linea con il suo solito.",
