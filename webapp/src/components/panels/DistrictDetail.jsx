...
export function DistrictDetail({ district, rank, metricKey, aggregation }) {
  ...
  const copy = language === "en"
    ? {
      ...
      anomalyHotter: "In 2025 this area was **hotter than its own usual** behaviour.",
      anomalyCooler: "In 2025 this area was **cooler than its own usual** behaviour.",
    ...
    : {
      ...
      surface: "Temperatura superficie",
      anomaly: "Anomalia",
      ...
      anomalyHotter: "Nel 2025 questa zona è stata **più calda del suo solito**.",
      anomalyCooler: "Nel 2025 questa zona è stata **più fresca del suo solito**.",
