...
export function ScatterPanel({
  ...
  const copy = language === "en"
    ...
    : {
      ...
      lowLegend: "piu' stabile",
      highLegend: "piu' variabile",
      ...
      metrics: {
        albedo: {
          ...
          intro:
            "**Come leggerlo:** L'asse orizzontale mostra superfici da piu' **assorbenti** a piu' **riflettenti** (**albedo / riflettanza**). L'asse verticale mostra l'**escursione termica** tra giorno e notte. Ogni punto rappresenta una cella di 1 km che interseca Bologna.",
          takeaway: [
            "**Superfici assorbenti:** mostrano spesso un'escursione piu' ampia.",
            "**Superfici riflettenti:** mostrano spesso un'escursione piu' bassa perche' si scaldano meno durante il giorno.",
          ],
          note: "La linea tratteggiata mostra l'andamento medio di Bologna. I punti blu sono piu' stabili del previsto; quelli rossi piu' variabili.",
          axisLabel: "riflettanza",
          surfaceTitle: "superficie",
          surfaceBuckets: { low: "assorbente", mid: "media", high: "riflettente" },
        },
        ndvi: {
          title: "Densita' della vegetazione ed escursione termica",
          intro:
            "**Come leggerlo:** L'asse orizzontale mostra la **densita' della vegetazione (NDVI)** — scarsa a sinistra, densa a destra. L'asse verticale mostra l'**escursione termica** tra giorno e notte. Ogni punto rappresenta una cella di 1 km che interseca Bologna.",
          takeaway: [
            "**Aree molto verdi:** mostrano spesso un'escursione piu' contenuta.",
            "**Aree poco vegetate o costruite:** tendono a oscillare di piu' tra giorno e notte.",
          ],
          note: "La linea tratteggiata mostra l'andamento medio di Bologna. I punti blu sono piu' stabili del previsto; quelli rossi piu' variabili.",
          axisLabel: "NDVI",
